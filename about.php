   <?php
	...
	if (isset($_POST["submit"])) {
		...
		$from = 'ray@extrabritesigns.com'; 
		$to = 'whelanderek@gmail.com'; 
...
<head>
    <title>Extrabrite - About Us</title>
	<meta charset="utf-8">
	...
	<section id="our_story" class="story">
		...
		<div class="container centered-column">
			<div class="col-sm-10 text-left centered-column">						
				<h2>Welcome to Extrabrite Signs</h2>
				<br>
			</div>
			<div class="col-sm-10 text-left centered-column grey-insert">
				<h3> <b>Mission Statement - </b>We aim to make the process of commissioning signage as simple as possible for our clients<h3>
		...
		<div class="container">
			...
			<div class="col-sm-6 text-left">
				<p class="text-left">We are a family-owned business specialising in signage fabrication and installation. We manufacture illuminated and individual lettering, graphic decals and wayfinding systems.</p>
				<p class="text-left">We pride ourselves on our ability to collaborate and problem-solve with our clients, whether they're architects, designers or business owners</p>
				<p class="text-left">Using our state-of-the-art workshop, our specialist design team produces high-quality, custom made products</p>
			</div>
			
			<div class="col-sm-4">
				<div>
					<p class="quote"> 
						"When I need a top-class finish in a short timeframe, I use Extrabrite"</h2>
					</p>
				</div>
		...
		<div class="container">
			...
			<div class="col-sm-5 col-sm-5 text-left ">	
				<div class="text-left">
					...
					<div class="container">
							<b>Telephone :</b> +353 1 295 4587<br>
							<b>Email : </b><a href="mailto:ray@extrabritesigns.com">ray@extrabritesigns.com</a> <br>							
							<b>Address : </b> 5 Jamestown Cottages, Kilternan, Dublin 18<br>
					</div>					
				</div>
